...
<xsl:template match="/">
    <html>
        <head>
            ...
            <link rel="stylesheet" href="css/PaddyCafe.css" />
            <script type="text/javascript" src="js/PaddyCafe.js">x</script>
        </head>
            <body>
                <h2>
                    <img src="img/PaddyCafe.gif" alt="Javaco Tea Logo" width="58" height="100" />Welcome to Paddy's Cafe</h2>
